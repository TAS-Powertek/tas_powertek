...
float IntervalData512::phase1Current_Harmonics(size_t harmonic) {
  switch (harmonic) {
    case 0:
...
float IntervalData512::phase2Current_Harmonics(size_t harmonic) {
  switch (harmonic) {
    case 0:
...
float IntervalData512::phase3Current_Harmonics(size_t harmonic) {
  switch (harmonic) {
    case 0:
...
void IntervalData512::bigEndian() {
  ...
  averageCapacitorCurrent_THD = folly::Endian::big(averageCapacitorCurrent_THD);
