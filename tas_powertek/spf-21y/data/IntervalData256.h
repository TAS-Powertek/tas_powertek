...
struct IntervalData256 {
  ...
  void bigEndian();
  static IntervalData256 fromByteStream(std::string_view data);
} FOLLY_PACK_ATTR;

static_assert(sizeof(IntervalData256) == 343);
static_assert(std::is_standard_layout_v<IntervalData256>);
}  // namespace tas_powertek::spf21y